...
// Input all mesh information
{
  ...
  fscanf(read1,"%i",&NumElems_in);  
  fgets(buffer, sizeof buffer, read1);
  fscanf(read1,"%i",&NumPhysElems_in);  
  fgets(buffer, sizeof buffer, read1);
  fscanf(read1,"%i",&NumGhostElems_in);  
  fgets(buffer, sizeof buffer, read1);
  fscanf(read1,"%i",&NumNodes_in);  
  fgets(buffer, sizeof buffer, read1);
  fscanf(read1,"%i",&NumPhysNodes_in);  
  fgets(buffer, sizeof buffer, read1);
  fscanf(read1,"%i",&NumBndNodes_in);  
  fgets(buffer, sizeof buffer, read1);
  fscanf(read1,"%i",&NumEdges_in);  
  fgets(buffer, sizeof buffer, read1);
  fscanf(read1,"%i",&NumBndEdges_in);  
  fgets(buffer, sizeof buffer, read1);
  int tmpint;
  fscanf(read1,"%i",&tmpint);
  if (tmpint==1)
    { is_submesh = true; }
  else
    { is_submesh = false; }
...
void mesh::InputSubMesh(char* inputdir)
{
  ...
  fscanf(read1,"%i",&SubFactor);
  fgets(buffer, sizeof buffer, read1);
  fscanf(read1,"%i",&SubNumPhysElems);
  fgets(buffer, sizeof buffer, read1);
  fscanf(read1,"%i",&SubNumPhysNodes);
  fgets(buffer, sizeof buffer, read1);
  fscanf(read1,"%i",&SubNumBndNodes); 
  fgets(buffer, sizeof buffer, read1);
  fclose(read1);
